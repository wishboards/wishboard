...
export const COLORS = {
  default: { stroke: '#60a5fa', fill: '#1d4ed8' },
  blue: { stroke: '#60a5fa', fill: '#1d4ed8' },
  error: { stroke: '#f87171', fill: '#991b1b' },
  red: { stroke: '#f87171', fill: '#991b1b' },
  throttle: { stroke: '#fb923c', fill: '#92400e' },
  orange: { stroke: '#fb923c', fill: '#92400e' },
  duration: { stroke: '#a78bfa', fill: '#4c1d95' },
  latency: { stroke: '#a78bfa', fill: '#4c1d95' },
  purple: { stroke: '#a78bfa', fill: '#4c1d95' },
  concurrent: { stroke: '#34d399', fill: '#065f46' },
  cache: { stroke: '#34d399', fill: '#065f46' },
  green: { stroke: '#34d399', fill: '#065f46' },
  bytes: { stroke: '#e879f9', fill: '#701a75' },
